          ...
          <div className="bg-white rounded-[1rem] p-8 shadow-[0_2px_4px_rgba(0,0,0,0.08),_0_4px_12px_rgba(0,0,0,0.05)] mb-8">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-r from-[#FF385C] to-[#E61E4D] text-white flex items-center justify-center font-semibold">
                  1
                </div>
                <div>
          ...
          <div className="bg-gray-50 rounded-[1rem] p-8">
            ...
            <ul className="space-y-2 text-[#6B6B6B]">
              <li className="flex items-start">
                <span className="text-[#FF385C] mr-2">•</span>
