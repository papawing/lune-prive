          ...
          <CardContent className="px-6 md:px-8 pb-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required
                  className="h-12 rounded-lg border-2 border-gray-200 focus:border-rausch focus:ring-0 transition-colors"
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-rausch hover:underline font-semibold">
            ...
            <div className="mt-8 text-center border-t border-gray-100 pt-6">
              <p className="text-sm text-light">
                {t("auth.noAccount")}{" "}
                <Link href="/register" className="text-rausch hover:underline font-semibold">
                  {t("auth.register")}
                </Link>
              </p>
            </div>
